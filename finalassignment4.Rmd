...
author: |
  ...
  | k.p.m.verduynlunel@students.uu.nl

  | http://www.github.com/kayverduynlunel
...
#Ana:
#Kay presents the following two tables which compare countries that have had revolutions (left table/first table) or have not had revolutions (right table/second table). The data is based on average growth rates over 1960-1995 for 65 countries with growth-related variables. In this case, countries with revolutions refer to the annual number of revolutions, insurrections and coup d'etats in that country in the same time span the data is based on. The two tables have each two rows and five variables. The two rows are growth (average annual percentage growth of real GDP from 1960 to 1995) and rgdp (the value of GDP per capita in 1960, converted to 1960 US Dollars.) The five variables or columns are the mean, median, SD, min, and max numbers of growth and rgdp.
...
>>>>>>> f07fc5cb70bacef9a4eae2eb5a2b3d9cef4b6e92
## The End